...
/** The end of the B2B branch: everything is stored for CRM review. */
export const B2B_COMPLETE: Localised = {
  en: 'Thank you — your B2B enquiry has been submitted for review.',
  ta: 'நன்றி — உங்கள் B2B விசாரணை பரிசீலனைக்காக சமர்ப்பிக்கப்பட்டது.',
  hi: 'धन्यवाद — आपकी B2B पूछताछ समीक्षा के लिए जमा कर दी गई है।',
  te: 'ధన్యవాదాలు — మీ B2B విచారణ సమీక్ష కోసం సమర్పించబడింది.',
  ml: 'നന്ദി — നിങ്ങളുടെ B2B അന്വേഷണം പരിശോധനയ്ക്കായി സമർപ്പിച്ചു.',
};

export const B2B_ALREADY_SUBMITTED: Localised = {
  en: 'Your B2B enquiry has already been submitted for review.',
  ta: 'உங்கள் B2B விசாரணை ஏற்கனவே பரிசீலனைக்காக சமர்ப்பிக்கப்பட்டுள்ளது.',
  hi: 'आपकी B2B पूछताछ पहले ही समीक्षा के लिए जमा की जा चुकी है।',
  te: 'మీ B2B విచారణ ఇప్పటికే సమీక్ష కోసం సమర్పించబడింది.',
  ml: 'നിങ്ങളുടെ B2B അന്വേഷണം ഇതിനകം പരിശോധനയ്ക്കായി സമർപ്പിച്ചിട്ടുണ്ട്.',
};
...
export const IDENTITY_MISMATCH: Localised = {
  en: 'We noticed a difference in some document details. It has been flagged for manual verification.',
  ta: 'சில ஆவண விவரங்களில் வேறுபாடு தெரிகிறது. இது கைமுறை சரிபார்ப்புக்காக குறிக்கப்பட்டுள்ளது.',
  hi: 'हमें कुछ दस्तावेज़ों की जानकारी में अंतर मिला है। इसे मैन्युअल सत्यापन के लिए चिह्नित किया गया है।',
  te: 'కొన్ని డాక్యుమెంట్ వివరాల్లో తేడా గమనించాం. ఇది మాన్యువల్ వెరిఫికేషన్ కోసం గుర్తించబడింది.',
  ml: 'ചില ഡോക്യുമെന്റ് വിവരങ്ങളിൽ വ്യത്യാസം ശ്രദ്ധിച്ചു. ഇത് മാനുവൽ പരിശോധനയ്ക്കായി അടയാളപ്പെടുത്തിയിട്ടുണ്ട്.',
};
...
export const TRACK_REJECTED: Localised = {
  en: 'Application ID: {{candidateId}}\nStatus: Not proceeding\n\nWe are not able to take this application forward. Your profile stays on file unless you choose to delete it.',
  ta: 'விண்ணப்ப எண்: {{candidateId}}\nநிலை: தொடரவில்லை\n\nஇந்த விண்ணப்பத்தை எங்களால் தொடர முடியவில்லை. நீங்கள் நீக்க விரும்பாத வரை உங்கள் விவரங்கள் பதிவில் இருக்கும்.',
  hi: 'एप्लिकेशन ID: {{candidateId}}\nस्थिति: आगे नहीं बढ़ रहे\n\nहम इस आवेदन को आगे नहीं बढ़ा पा रहे हैं। जब तक आप इसे हटाना नहीं चुनते, आपकी प्रोफ़ाइल रिकॉर्ड में रहेगी।',
  te: 'Application ID: {{candidateId}}\nస్థితి: ముందుకు వెళ్లడం లేదు\n\nఈ దరఖాస్తును మేము ముందుకు తీసుకెళ్లలేకపోతున్నాము. మీరు తొలగించాలనుకునే వరకు మీ ప్రొఫైల్ రికార్డులో ఉంటుంది.',
  ml: 'അപേക്ഷ ഐഡി: {{candidateId}}\nസ്ഥിതി: മുന്നോട്ട് പോകുന്നില്ല\n\nഈ അപേക്ഷ മുന്നോട്ട് കൊണ്ടുപോകാൻ കഴിയില്ല. നിങ്ങൾ നീക്കം ചെയ്യുന്നതുവരെ നിങ്ങളുടെ പ്രൊഫൈൽ രേഖയിൽ തുടരും.',
};
...
export const TRACK_DOB_EXHAUSTED: Localised = {
  en: 'I could not verify this application through chat.',
  ta: 'இந்த விண்ணப்பத்தை அரட்டை மூலம் சரிபார்க்க முடியவில்லை.',
  hi: 'मैं चैट के माध्यम से इस आवेदन को सत्यापित नहीं कर सका।',
  te: 'ఈ దరఖాస్తును చాట్ ద్వారా ధృవీకరించలేకపోయాను.',
  ml: 'ഈ അപേക്ഷ ചാറ്റിലൂടെ സ്ഥിരീകരിക്കാൻ കഴിഞ്ഞില്ല.',
};
...
export const TRACK_CANNOT_VERIFY: Localised = {
  en: 'I cannot show this application because a required verification detail is not on file.',
  ta: 'தேவையான சரிபார்ப்பு விவரம் பதிவில் இல்லாததால் இந்த விண்ணப்பத்தைக் காட்ட முடியவில்லை.',
  hi: 'ज़रूरी सत्यापन जानकारी रिकॉर्ड में नहीं होने के कारण मैं यह आवेदन नहीं दिखा सकता।',
  te: 'అవసరమైన ధృవీకరణ వివరాలు రికార్డులో లేనందున ఈ దరఖాస్తును చూపలేను.',
  ml: 'ആവശ്യമായ പരിശോധനാ വിവരം രേഖയിൽ ഇല്ലാത്തതിനാൽ ഈ അപേക്ഷ കാണിക്കാൻ കഴിയില്ല.',
};
...
export const STAFF_INTAKE_START: Localised = {
  en: 'Please provide a few details for your request.',
  ta: 'உங்கள் கோரிக்கைக்காக சில விவரங்களை வழங்கவும்.',
  hi: 'कृपया अपने अनुरोध के लिए कुछ जानकारी दें।',
  te: 'దయచేసి మీ అభ్యర్థన కోసం కొన్ని వివరాలు ఇవ్వండి.',
  ml: 'നിങ്ങളുടെ അഭ്യർത്ഥനയ്ക്കായി കുറച്ച് വിവരങ്ങൾ നൽകൂ.',
};

export const STAFF_INTAKE_COMPLETE: Localised = {
  en: 'Thank you. Your request has been recorded.\nReference number: {{enquiryId}}',
  ta: 'நன்றி. உங்கள் கோரிக்கை பதிவு செய்யப்பட்டது.\nகுறிப்பு எண்: {{enquiryId}}',
  hi: 'धन्यवाद। आपका अनुरोध दर्ज कर लिया गया है।\nरेफरेंस नंबर: {{enquiryId}}',
  te: 'ధన్యవాదాలు. మీ అభ్యర్థన నమోదు చేయబడింది.\nరిఫరెన్స్ నంబర్: {{enquiryId}}',
  ml: 'നന്ദി. നിങ്ങളുടെ അഭ്യർത്ഥന രേഖപ്പെടുത്തി.\nറഫറൻസ് നമ്പർ: {{enquiryId}}',
};
...
export const JOBS_ANSWER: Localised = {
  en: 'Your profile is on file. Suitable jobs depend on the vacancies currently available, and registration does not guarantee selection.',
  ta: 'உங்கள் விவரங்கள் பதிவில் உள்ளன. பொருத்தமான வேலைகள் தற்போது உள்ள காலியிடங்களைப் பொறுத்தது; பதிவு செய்தால் தேர்வு உறுதி அல்ல.',
  hi: 'आपकी प्रोफ़ाइल रिकॉर्ड में है। उपयुक्त नौकरियाँ वर्तमान रिक्तियों पर निर्भर करती हैं और रजिस्ट्रेशन चयन की गारंटी नहीं है।',
  te: 'మీ ప్రొఫైల్ రికార్డులో ఉంది. సరైన ఉద్యోగాలు ప్రస్తుతం ఉన్న ఖాళీలపై ఆధారపడతాయి; నమోదు ఎంపికకు హామీ కాదు.',
  ml: 'നിങ്ങളുടെ പ്രൊഫൈൽ രേഖയിൽ ഉണ്ട്. അനുയോജ്യമായ ജോലികൾ നിലവിലെ ഒഴിവുകളെ ആശ്രയിച്ചിരിക്കും; രജിസ്ട്രേഷൻ തിരഞ്ഞെടുപ്പിന് ഉറപ്പല്ല.',
};
...
export const OUT_OF_SCOPE: Localised = {
  en: 'I cannot answer that in this registration chat. Let us continue with your registration.',
  ta: 'இந்தப் பதிவு அரட்டையில் அதற்குப் பதிலளிக்க முடியாது. உங்கள் பதிவைத் தொடரலாம்.',
  hi: 'मैं इस रजिस्ट्रेशन चैट में इसका जवाब नहीं दे सकता। आइए आपका रजिस्ट्रेशन जारी रखें।',
  te: 'ఈ నమోదు చాట్‌లో దానికి సమాధానం ఇవ్వలేను. మీ నమోదును కొనసాగిద్దాం.',
  ml: 'ഈ രജിസ്ട്രേഷൻ ചാറ്റിൽ അതിന് മറുപടി നൽകാൻ കഴിയില്ല. രജിസ്ട്രേഷൻ തുടരാം.',
};
...
/** Asked when a B2B document still cannot be stored after repeated attempts. */
export const STUCK: Localised = {
  en: 'I still could not save that document. Please upload a clear image or PDF and try again.',
  ta: 'அந்த ஆவணத்தை இன்னும் சேமிக்க முடியவில்லை. தெளிவான படம் அல்லது PDF ஐ பதிவேற்றி மீண்டும் முயற்சிக்கவும்.',
  hi: 'मैं अभी भी वह दस्तावेज़ सेव नहीं कर सका। कृपया साफ़ फोटो या PDF अपलोड करके फिर कोशिश करें।',
  te: 'ఆ డాక్యుమెంట్‌ను ఇంకా సేవ్ చేయలేకపోయాను. స్పష్టమైన చిత్రం లేదా PDF అప్‌లోడ్ చేసి మళ్లీ ప్రయత్నించండి.',
  ml: 'ആ രേഖ ഇനിയും സേവ് ചെയ്യാൻ കഴിഞ്ഞില്ല. വ്യക്തമായ ചിത്രം അല്ലെങ്കിൽ PDF അപ്‌ലോഡ് ചെയ്ത് വീണ്ടും ശ്രമിക്കൂ.',
};
...
export const AGE_HANDOFF: Localised = {
  en: 'We are sorry, but you do not meet the minimum age required for this service, so we cannot continue this registration.',
  ta: 'மன்னிக்கவும். இந்தச் சேவைக்கான குறைந்தபட்ச வயது தகுதி உங்களுக்கு இல்லாததால் பதிவைத் தொடர முடியாது.',
  hi: 'हमें खेद है, लेकिन आप इस सेवा की न्यूनतम आयु आवश्यकता पूरी नहीं करते, इसलिए हम यह रजिस्ट्रेशन जारी नहीं रख सकते।',
  te: 'క్షమించండి. ఈ సేవకు అవసరమైన కనీస వయస్సు మీకు లేనందున ఈ నమోదును కొనసాగించలేము.',
  ml: 'ക്ഷമിക്കണം. ഈ സേവനത്തിന് ആവശ്യമായ കുറഞ്ഞ പ്രായം ഇല്ലാത്തതിനാൽ രജിസ്ട്രേഷൻ തുടരാൻ കഴിയില്ല.',
};

/** Sent once when CV/passport OCR proves the applicant is not an Indian national. */
export const NATIONALITY_NOT_SUPPORTED: Localised = {
  en: 'We are sorry, but our overseas recruitment service is currently available only to Indian nationals, so we cannot continue this registration.',
  ta: 'மன்னிக்கவும். எங்கள் வெளிநாட்டு வேலைவாய்ப்பு சேவை தற்போது இந்திய குடிமக்களுக்கு மட்டுமே கிடைக்கிறது. எனவே இந்தப் பதிவைத் தொடர முடியாது.',
  hi: 'हमें खेद है। हमारी विदेशी भर्ती सेवा अभी केवल भारतीय नागरिकों के लिए उपलब्ध है, इसलिए हम यह पंजीकरण जारी नहीं रख सकते।',
  te: 'క్షమించండి. మా విదేశీ ఉద్యోగ సేవ ప్రస్తుతం భారతీయ పౌరులకు మాత్రమే అందుబాటులో ఉంది. అందువల్ల ఈ నమోదును కొనసాగించలేము.',
  ml: 'ക്ഷമിക്കണം. ഞങ്ങളുടെ വിദേശ തൊഴിൽ സേവനം നിലവിൽ ഇന്ത്യൻ പൗരന്മാർക്ക് മാത്രമാണ് ലഭ്യം. അതിനാൽ ഈ രജിസ്ട്രേഷൻ തുടരാനാകില്ല.',
};
