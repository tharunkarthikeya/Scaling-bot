    ...
    questions: [
      {
        ...
        prompt: {
          ...
          te: 'మీకు ఏ వెల్డింగ్ పద్ధతులు తెలుసు?',
          ml: 'നിങ്ങൾക്ക് ഏതൊക്കെ വെൽഡിംഗ് പ്രോസസ്സ് അറിയാം?',
        },
        multi: true,
        choices: [
          { id: 'tig', label: { en: 'TIG', ta: 'TIG', hi: 'TIG', te: 'TIG', ml: 'TIG' }, evidence: ['tig', 'gtaw'] },
          {
            id: 'arc_smaw',
            label: { en: 'ARC / SMAW', ta: 'ARC / SMAW', hi: 'ARC / SMAW', te: 'ARC / SMAW', ml: 'ARC / SMAW' },
            evidence: ['smaw', 'stick welding', 'shielded metal arc'],
          },
          { id: 'mig', label: { en: 'MIG', ta: 'MIG', hi: 'MIG', te: 'MIG', ml: 'MIG' }, evidence: ['mig', 'gmaw'] },
          {
            id: 'fcaw',
            label: { en: 'FCAW', ta: 'FCAW', hi: 'FCAW', te: 'FCAW', ml: 'FCAW' },
            evidence: ['fcaw', 'flux cored'],
          },
          {
            id: 'saw',
            label: { en: 'SAW', ta: 'SAW', hi: 'SAW', te: 'SAW', ml: 'SAW' },
        ...
        otherPrompt: {
          ...
          te: 'దయచేసి వెల్డింగ్ పద్ధతి టైప్ చేయండి.',
          ml: 'വെൽഡിംഗ് പ്രോസസ്സ് ടൈപ്പ് ചെയ്യൂ.',
        },
      },
      {
        ...
        prompt: {
          ...
          te: 'మీ దగ్గర వాలిడ్ వెల్డింగ్ సర్టిఫికెట్ ఉందా?',
          ml: 'നിങ്ങൾക്ക് ശരിയായ വെൽഡിംഗ് സർട്ടിഫിക്കറ്റ് ഉണ്ടോ?',
        },
        multi: false,
        choices: [
          { id: 'yes', label: { en: 'Yes', ta: 'ஆம்', hi: 'हाँ', te: 'అవును', ml: 'അതെ' } },
          { id: 'no', label: { en: 'No', ta: 'இல்லை', hi: 'नहीं', te: 'కాదు', ml: 'അല്ല' } },
          { id: 'expired', label: { en: 'Expired', ta: 'காலாவதி', hi: 'एक्सपायर', te: 'గడువు ముగిసింది', ml: 'കാലാവധി കഴിഞ്ഞു' } },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        prompt: {
          ...
          te: 'మీరు ఏ రకమైన ఫాబ్రికేషన్ పని చేస్తారు?',
          ml: 'നിങ്ങൾ ഏത് തരം ഫാബ്രിക്കേഷൻ ജോലിയാണ് ചെയ്യുന്നത്?',
        },
        multi: true,
        choices: [
          {
            id: 'structural',
            label: { en: 'Structural', ta: 'ஸ்ட்ரக்சரல்', hi: 'स्ट्रक्चरल', te: 'స్ట్రక్చరల్', ml: 'സ്ട്രക്ചറൽ' },
            evidence: ['structural steel', 'structural fabrication'],
          },
          {
            id: 'peb',
            label: { en: 'PEB', ta: 'PEB', hi: 'PEB', te: 'PEB', ml: 'PEB' },
            evidence: ['peb', 'pre engineered building'],
          },
          {
            id: 'tank',
            label: { en: 'Tank', ta: 'டேங்க்', hi: 'टैंक', te: 'ట్యాంక్', ml: 'ടാങ്ക്' },
            evidence: ['storage tank', 'storage tanks'],
          },
          {
            id: 'vessel',
            label: { en: 'Vessel', ta: 'வெசல்', hi: 'वेसल', te: 'వెసల్', ml: 'വെസൽ' },
            evidence: ['pressure vessel', 'pressure vessels', 'heat exchanger'],
          },
          {
            id: 'pipe',
            label: { en: 'Pipe', ta: 'பைப்', hi: 'पाइप', te: 'పైపు', ml: 'പൈപ്പ്' },
            evidence: ['piping', 'pipe fabrication', 'pipe fitting'],
          },
          {
            id: 'sheet_metal',
            label: { en: 'Sheet metal', ta: 'ஷீட் மெட்டல்', hi: 'शीट मेटल', te: 'షీట్ మెటల్', ml: 'ഷീറ്റ് മെറ്റൽ' },
        ...
        otherPrompt: {
          ...
          te: 'ఫాబ్రికేషన్ పని ఏం రకమో టైప్ చేయండి.',
          ml: 'ഏത് തരം ഫാബ്രിക്കേഷൻ പണിയാണെന്ന് ടൈപ്പ് ചെയ്യൂ.',
        },
      },
    ],
  },
    ...
    questions: [
      {
        ...
        prompt: {
          ...
          te: 'మీరు ఏ వాహనాలు నడపగలరు?',
          ml: 'നിങ്ങൾക്ക് ഏതൊക്കെ വണ്ടി ഓടിക്കാൻ അറിയാം?',
        },
        multi: true,
        choices: [
          { id: 'light', label: { en: 'Light vehicle', ta: 'லைட் வாகனம்', hi: 'लाइट व्हीकल', te: 'లైట్ వెహికల్', ml: 'ലൈറ്റ് വാഹനം' } },
          { id: 'heavy', label: { en: 'Heavy vehicle', ta: 'ஹெவி வாகனம்', hi: 'हैवी व्हीकल', te: 'హెవీ వెహికల్', ml: 'ഹെവി വാഹനം' } },
          { id: 'trailer', label: { en: 'Trailer', ta: 'டிரெய்லர்', hi: 'ट्रेलर', te: 'ట్రైలర్', ml: 'ട്രെയിലർ' } },
          { id: 'bus', label: { en: 'Bus', ta: 'பஸ்', hi: 'बस', te: 'బస్సు', ml: 'ബസ്' } },
          { id: 'forklift', label: { en: 'Forklift', ta: 'ஃபோர்க்லிஃப்ட்', hi: 'फोर्कलिफ्ट', te: 'ఫోర్క్‌లిఫ్ట్', ml: 'ഫോർക്ക്‌ലിഫ്റ്റ്' } },
          { id: 'equipment', label: { en: 'Equipment', ta: 'எக்யூப்மென்ட்', hi: 'इक्विपमेंट', te: 'పరికరాలు', ml: 'ഉപകരണം' } },
          { id: 'other', label: OTHER },
        ],
        otherPrompt: {
          ...
          te: 'మీరు ఏ వాహనం నడుపుతారో టైప్ చేయండి.',
          ml: 'നിങ്ങൾ ഓടിക്കുന്ന വണ്ടി ടൈപ്പ് ചെയ്യൂ.',
        },
      },
      {
        id: 'driver_licences',
        prompt: {
          ...
          te: 'మీ దగ్గర ఏ డ్రైవింగ్ లైసెన్స్‌లు ఉన్నాయి?',
          ml: 'നിങ്ങളുടെ കയ്യിൽ ഏതൊക്കെ ഡ്രൈവിംഗ് ലൈസൻസ് ഉണ്ട്?',
        },
        multi: true,
        allowMedia: true,
        choices: [
          { id: 'indian_lmv', label: { en: 'Indian LMV', ta: 'இந்திய LMV', hi: 'भारतीय LMV', te: 'ఇండియన్ LMV', ml: 'ഇന്ത്യൻ LMV' } },
          { id: 'indian_hmv', label: { en: 'Indian HMV', ta: 'இந்திய HMV', hi: 'भारतीय HMV', te: 'ఇండియన్ HMV', ml: 'ഇന്ത്യൻ HMV' } },
          { id: 'gulf', label: { en: 'Gulf licence', ta: 'வளைகுடா உரிமம்', hi: 'गल्फ लाइसेंस', te: 'గల్ఫ్ లైసెన్స్', ml: 'ഗൾഫ് ലൈസൻസ്' } },
          { id: 'international', label: { en: 'International', ta: 'சர்வதேசம்', hi: 'इंटरनेशनल', te: 'ఇంటర్నేషనల్', ml: 'ഇന്റർനാഷണൽ' } },
          { id: 'none', label: { en: 'None yet', ta: 'இன்னும் இல்லை', hi: 'अभी नहीं', te: 'ఇంకా ఏమీ లేదు', ml: 'ഇതുവരെ ഇല്ല' } },
          { id: 'other', label: OTHER },
        ],
        otherPrompt: {
          ...
          te: 'మీ దగ్గర ఏ లైసెన్స్ ఉందో టైప్ చేయండి.',
          ml: 'ദയവായി നിങ്ങളുടെ കയ്യിലുള്ള ലൈസൻസ് ടൈപ്പ് ചെയ്യൂ.',
        },
      },
    ],
  },
    ...
    questions: [
      {
        ...
        prompt: {
          ...
          te: 'మీరు ఏ CNC మెషీన్లు ఆపరేట్ చేశారు? టైప్ చేయవచ్చు, ఫోటో పంపవచ్చు, లేదా వాయిస్ నోట్ పంపవచ్చు.',
          ml: 'ഏത് CNC മെഷീനുകളാണ് നിങ്ങൾ ഓപ്പറേറ്റ് ചെയ്തിട്ടുള്ളത്? ടൈപ്പ് ചെയ്യാം, ഫോട്ടോ അയക്കാം, അല്ലെങ്കിൽ വോയ്‌സ് നോട്ട് അയക്കാം.',
        },
        multi: false,
        allowMedia: true,
        choices: [],
    ...
    questions: [
      {
        ...
        prompt: {
          ...
          te: 'మీ దగ్గర ఏ వాలిడ్ సర్టిఫికేషన్లు ఉన్నాయి?',
          ml: 'നിങ്ങളുടെ കയ്യിൽ ഏതൊക്കെ വാലിഡ് സർട്ടിഫിക്കേഷനുകൾ ഉണ്ട്?',
        },
        multi: true,
        choices: [
          { id: 'asnt', label: { en: 'ASNT', ta: 'ASNT', hi: 'ASNT', te: 'ASNT', ml: 'ASNT' }, evidence: ['asnt'] },
          { id: 'pcn', label: { en: 'PCN', ta: 'PCN', hi: 'PCN', te: 'PCN', ml: 'PCN' }, evidence: ['pcn'] },
          { id: 'irata', label: { en: 'IRATA', ta: 'IRATA', hi: 'IRATA', te: 'IRATA', ml: 'IRATA' }, evidence: ['irata'] },
          { id: 'other', label: OTHER },
        ],
        otherPrompt: {
          ...
          te: 'దయచేసి సర్టిఫికేషన్ టైప్ చేయండి.',
          ml: 'ദയവായി സർട്ടിഫിക്കേഷൻ ടൈപ്പ് ചെയ്യൂ.',
        },
      },
    ],
  },
...
export const DISAMBIGUATIONS: Disambiguation[] = [
  {
    ...
    choices: [
      {
        id: 'welding',
        label: { en: 'Welding', ta: 'வெல்டிங்', hi: 'वेल्डिंग', te: 'వెల్డింగ్', ml: 'വെൽഡിംഗ്' },
        packs: ['welder'],
      },
      {
        id: 'fabrication',
        label: { en: 'Fabrication', ta: 'ஃபேப்ரிகேஷன்', hi: 'फैब्रिकेशन', te: 'ఫ్యాబ్రికేషన్', ml: 'ഫാബ്രിക്കേഷൻ' },
        packs: ['fabricator'],
      },
      {
        id: 'both',
        label: { en: 'Both', ta: 'இரண்டும்', hi: 'दोनों', te: 'రెండూ', ml: 'രണ്ടും' },
